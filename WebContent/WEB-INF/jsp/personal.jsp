...
<div class="layui-body">
    <!-- 内容主体区域 -->
       ...
       <p class="layadmin-homepage-about">
         	<font size="5" color="green">技能:</font>
        </p>
    ...
    <tr>
      ...
      <td><c:out value="${user.registertime}"></c:out></td>
 	  <td><c:out value="${user.birthdate}"></c:out></td>
 	  <td><c:out value="${user.experience}"></c:out></td>
      <td><c:out value="${user.headphoto}"></c:out></td>
    </tr>
    </c:forEach>
</table>
 <img src="${pageContext.request.contextPath}/img/p.jpg" width="1700",height="200" />
