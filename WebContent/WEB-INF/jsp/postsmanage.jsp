...
<!-- 最上方 -->
  <div class="layui-header">
    <div class="layui-logo">Java论坛后台管理-帖子管理</div>
...
<!-- 显示 -->
    ...
    <c:forEach items="${pList}" var="p">
      <tr id="posts">
         <td><p style="text-align:center"><c:out value="${p.pid}"></p></c:out></td>
         <td><p style="text-align:center"><c:out value="${p.user_id}"></p></c:out></td>
         <td><p style="text-align:center"><c:out value="${p.board_id}"></p></c:out></td>
         <td><p style="text-align:center"><c:out value="${p.postheat}"></c:out></p></td>
         <td><p style="text-align:center"><c:out value="${p.posttitle}"></p></c:out></td>
         <td><p style="text-align:center"><c:out value="${p.posttime}"></p></c:out></td>
        <%-- <td><button type="button" οnclick="window.location.href='http://localhost:8080/BBSz/delect.do?id=${b.bid};'">删除</button></td> --%>
		<td><p style="text-align:center" onclick="del()"><a href="http://localhost:8080/BBSz/delete3.do?pid=${p.pid}">删除</a></p></td>
        </tr>              
    </c:forEach>
